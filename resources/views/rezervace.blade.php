          ...
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="{{ route('rezervace.store') }}" method="post">
                @csrf
                <div class="box-root padding-top--40 padding-bottom--24 flex-flex flex-justifyContent--center">
                  Žádost o termín u lékaře (ambulance v nemocnici)
                </div>
                <div class="box-root padding-top--40 padding-bottom--24 flex-flex flex-justifyContent--center">
                  Je nám líto, že jste se k nám nedovolali. Zanechte nám na sebe identifikační a kontaktní údaje, budeme Vás s možným termínem kontaktovat do 48 hodin v rámci
                  pracovní doby od 8:00 - 13:30.
                </div>
                ...
                <div class="field padding-bottom--24">
                  <label for="phone">Telefonní číslo (mobil), na kterém Vás můžeme kontaktovat.</label>
                ...
                <div class="field padding-bottom--24">
                  <label for="evidence">Jste již v evidenci naší ambulance?</label>
                ...
                <div class="field padding-bottom--24">
                  <label for="type">V jaké oblasti řešíte zdravotní problém</label>
                  <select name="type">
                    <option value="Ortopedie">Ortopedie</option>
                    <option value="Spondylochirurgie">Spondylochirurgie (nemoci páteře)</option>
                  </select>
                </div>

                <div class="field padding-bottom--24">
                  <label for="message">Text Vaši žádosti</label>
