    ...
    <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
      ...
      <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
        <div class="box-root padding-top--40 padding-bottom--24 flex-flex flex-justifyContent--center">
          <h1><a href="#" rel="dofollow">Rezervace Ortopedické ambulance KHN a.s.</a></h1>
        </div>
          ...
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="stripe-login" action="{{ route('rezervace.store') }}" method="post">
                ...
                <div class="field padding-bottom--24">
                  <label for="phone">Telefon na který se vám ozveme</label>
                ...
                <div class="field padding-bottom--24">
                  <label for="message">Bližší informace ( zpráva )</label>
